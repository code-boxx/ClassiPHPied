<?php
$_PMETA = ["load" => [
  ["s", HOST_ASSETS."ADM-login.js", "defer"]
]];
require PATH_PAGES . "TEMPLATE-atop.php"; ?>
<div class="row justify-content-center">
<div class="col-md-10 bg-white border">
  <div class="row">
    <div class="col-4" style="background:url('<?=HOST_ASSETS?>work.jpg') center"></div>
    <form class="col-8 p-5" onsubmit="return signin();">
      <img src="<?=HOST_ASSETS?>favicon.png" class="p-2 bg-primary rounded-circle"/>
