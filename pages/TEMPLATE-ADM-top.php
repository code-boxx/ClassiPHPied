...
<html>
  <head>
    ...
    <meta name="apple-mobile-web-app-title" content="ClassiPHPied Admin">
    ...
    <div id="cb-body" class="d-flex">
      ...
      <nav id="cb-side" class="bg-dark text-white p-2"><ul class="navbar-nav">
        <li class="nav-item">
          ...
          <hr>
          <div class="mb-2">Classifieds</div>
          <a class="nav-link ms-2" href="<?=HOST_ADMIN?>">
            <span class="mi mi-smol">campaign</span> Ads
          </a>
          <a class="nav-link ms-2" href="<?=HOST_ADMIN?>category">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link ms-2" href="<?=HOST_ADMIN?>about">
