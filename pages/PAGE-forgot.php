...
<div class="row">
  <div class="col-3" style="background:url('<?=HOST_UPLOADS?>forgot.webp') center;background-size:cover"></div>
  <form class="col-9 p-4" onsubmit="return forgot();">
    ...
    <div><a href="<?=HOST_ADMIN?>login">Back To Login</a></div>
  </form>
</div>
</div>
</div>
...
<div class="row">
  ...
  <div class="col-9 p-4">
    ...
    <h3 class="mt-4"><?=$pass?"DONE!":"OOOOOPPPSSSSSS...."?></h3>
    <div class="mb-4"><?php
      if ($pass) { echo "OK - New password sent to your email."; }
      else { echo $_CORE->error; }
    ?></div>
    <div class="mb-5"><a href="<?=HOST_ADMIN?>login">Back To Login</a></div>
  </div>
</div>
</div>
</div>
